    ...
    <div className="p-6">
      ...
      <div className="space-y-4 mb-6">
        <button
          ...
          disabled={loading}
          className="px-4 py-2 bg-blue-500 text-foreground rounded hover:bg-blue-600 disabled:opacity-50"
        >
          Test Health Check
        </button>
        ...
        <button
          onClick={testUsers}
          disabled={loading}
          className="px-4 py-2 bg-green-500 text-foreground rounded hover:bg-green-600 disabled:opacity-50 ml-4"
        >
          Test Users API
        </button>
        ...
        <button
          onClick={testAuth}
          disabled={loading}
          className="px-4 py-2 bg-purple-500 text-foreground rounded hover:bg-purple-600 disabled:opacity-50 ml-4"
        >
          Test Auth API
        </button>
      </div>
