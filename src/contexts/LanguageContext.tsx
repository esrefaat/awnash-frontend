...
const translations = {
  ...
  ur: {
    ...
    'equipment_moderation': 'سازوسامان کی نگرانی',
    'revenue': 'آمدنی',
    'total_users': 'کل صارفین',
    'total_equipment': 'کل سازوسامان',
    'total_bookings': 'کل بکنگز',
    'pending_moderation': 'زیر التواء نگرانی',
    'search': 'تلاش',
    'filter': 'فلٹر',
    'export': 'ایکسپورٹ',
    ...
    'awnash_admin': 'اونش ایڈمن ڈیش بورڈ',
    ...
    'creating': 'بنا رہا ہے...',
    'add_equipment': 'سازوسامان شامل کریں',
    'search_equipment': 'سازوسامان تلاش کریں...',
    'search_bookings': 'بکنگز تلاش کریں...',
    'photography': 'فوٹوگرافی',
    'videography': 'ویڈیوگرافی',
    'audio': 'آڈیو',
    'lighting': 'روشنی',
    'confirmed': 'تصدیق شدہ',
    'completed': 'مکمل',
    ...
    'text_resources_management': 'متن اور وسائل کا انتظام',
    'transaction_user_reports': 'لین دین اور صارف رپورٹس',
    'request_management': 'درخواست کا انتظام',
    'region_management': 'علاقے کا انتظام',
    'equipment_management': 'سازوسامان کا انتظام',
    'permissions_management': 'اجازتوں کا انتظام',
    'reviews_ratings_management': 'جائزے اور درجہ بندی کا انتظام',
    'system_settings': 'سسٹم کی ترتیبات',
    'activity_log': 'سرگرمی لاگ',
    'sign_out': 'سائن آؤٹ',
    'reports': 'رپورٹس',
    'campaign_management': 'مہم کا انتظام',
    'campaign_analytics': 'مہم کے تجزیات',
    'operational_calendar': 'آپریشنل کیلنڈر'
  }
};
